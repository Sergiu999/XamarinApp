...
namespace XamarinApp.FormsSection.Exercise
{
    ...
    public partial class ContactDetailPage : ContentPage
    {
        ...
        public event EventHandler<FormsContact> ContactAdded;
        public event EventHandler<FormsContact> ContactUpdated;

        public ContactDetailPage(FormsContact contact)
        {
            ...
            // updated.
            BindingContext = new FormsContact
            {
                Id = contact.Id,
