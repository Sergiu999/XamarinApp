...
namespace XamarinApp.FormsSection.Exercise
{
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class ContactsPage : ContentPage
    {
        private ObservableCollection<FormsContact> _contacts;

        public ContactsPage()
        {
            InitializeComponent();

            _contacts = new ObservableCollection<FormsContact>
            {
                new FormsContact { Id = 1, FirstName = "John", LastName = "Smith", Email = "john@smith.com", Phone = "1111" },
                new FormsContact { Id = 2, FirstName = "Mary", LastName = "Johnson", Email = "mary@johnson.com", Phone = "2222" }
            };
        ...
        {
            var page = new ContactDetailPage(new FormsContact());
        ...
        async void OnContactSelected(object sender, Xamarin.Forms.SelectedItemChangedEventArgs e)
        {
            ...
            var selectedContact = e.SelectedItem as FormsContact;
        ...
        {
            var contact = (sender as MenuItem).CommandParameter as FormsContact;
